...
const GOLDEN: readonly GoldenRow[] = [
  ...
  { salt: "canary", key: "A", raw: 0x0be65c6b74a5b1cen, bucket: 54, why: "case-flipped vs 'a'" },
  {
    salt: "canary",
    key: "z",
    raw: 0x0be6236b74a550f3n,
    bucket: 27,
    why: "single ASCII letter, high",
  },
  ...
  { salt: "canary", key: " ", raw: 0x0be5fd6b74a51061n, bucket: 9, why: "single space" },
  {
    salt: "canary",
    key: "  ",
    raw: 0xdcddde97347a9e73n,
    bucket: 51,
    why: "two spaces (length sensitivity)",
  },
  {
    salt: "canary",
    key: "tenant-alpha",
    raw: 0xa95582926a936032n,
    bucket: 54,
    why: "plain ASCII tenant id",
  },
  {
    salt: "canary",
    key: "Tenant-Alpha",
    raw: 0x2f0ee6c1bc3fcb72n,
    bucket: 42,
    why: "case-only difference vs tenant-alpha",
  },
  {
    salt: "canary",
    key: "TENANT-ALPHA",
    raw: 0xee8a1590af3158d2n,
    bucket: 18,
    why: "all-caps, case-only difference",
  },
  {
    salt: "canary",
    key: "sk-live-000000000000000000000000000a",
    raw: 0xdc82e21865df63den,
    bucket: 90,
    why: "api-key shaped",
  },
  {
    salt: "canary",
    key: "sk-live-000000000000000000000000000b",
    raw: 0xdc82e11865df622bn,
    bucket: 79,
    why: "differs in LAST byte only",
  },
  { salt: "canary", key: "key-1000", raw: 0x9058a2d7b27291fcn, bucket: 88, why: "sequential key" },
  {
    salt: "canary",
    key: "key-1001",
    raw: 0x9058a3d7b27293afn,
    bucket: 99,
    why: "differs in last byte only",
  },
  {
  ...
  },
  {
    salt: "canary",
    key: "caf\u00e9",
    raw: 0x75a08981fed6192fn,
    bucket: 83,
    why: "2-byte UTF-8 U+00E9; latin1 truncation diverges",
  },
  {
    salt: "canary",
    key: "caf\u00c9",
    raw: 0x75a0a981fed64f8fn,
    bucket: 35,
    why: "2-byte UTF-8, case-only difference",
  },
  {
    salt: "canary",
    key: "\u65e5\u672c\u8a9e",
    raw: 0xd7c32615a9844c65n,
    bucket: 77,
    why: "3-byte UTF-8 CJK",
  },
  {
    salt: "canary",
    key: "\u65e5\u672c\u8a9f",
    raw: 0xd7c32515a9844ab2n,
    bucket: 66,
    why: "3-byte UTF-8, last codepoint +1",
  },
  {
    salt: "canary",
    key: "\u{1f680}",
    raw: 0xe2f3851d7207a8f0n,
    bucket: 60,
    why: "4-byte UTF-8 U+1F680, surrogate pair in UTF-16",
  },
  {
    salt: "canary",
    key: "\u{1f680}\u{1f680}",
    raw: 0xfd4c54740b5aeecfn,
    bucket: 35,
    why: "two astral codepoints",
  },
  {
    salt: "canary",
    key: "a\u0000b",
    raw: 0xe9c150ef61cea818n,
    bucket: 20,
    why: "embedded NUL (framing edge)",
  },
  {
    salt: "canary",
    key: "\u0000",
    raw: 0x0be61d6b74a546c1n,
    bucket: 61,
    why: "lone NUL key (framing edge)",
  },
  {
    salt: "canary",
    key: "\u007f",
    raw: 0x0be6266b74a5560cn,
    bucket: 60,
    why: "U+007F, last 1-byte UTF-8",
  },
  {
    salt: "canary",
    key: "\u0080",
    raw: 0xdc69f2973417cfe1n,
    bucket: 65,
    why: "U+0080, first 2-byte UTF-8",
  },
  {
    salt: "canary",
    key: "\u07ff",
    raw: 0xdc227b9733db0309n,
    bucket: 45,
    why: "U+07FF, last 2-byte UTF-8",
  },
  {
    salt: "canary",
    key: "\u0800",
    raw: 0x9b8d6decf0e924a9n,
    bucket: 29,
    why: "U+0800, first 3-byte UTF-8",
  },
  {
    salt: "canary",
    key: "\uffff",
    raw: 0x5e9727ecce4ac812n,
    bucket: 38,
    why: "U+FFFF, last BMP 3-byte UTF-8",
  },
  {
    salt: "canary",
    key: "\u{10000}",
    raw: 0x7243e21d322e674bn,
    bucket: 15,
    why: "U+10000, first 4-byte UTF-8",
  },
  {
    salt: "canary",
    key: "\u{10ffff}",
    raw: 0x1ce5343ea30baa5cn,
    bucket: 52,
    why: "U+10FFFF, last codepoint",
  },
  {
    salt: "canary",
    key: LONG_ASCII,
    raw: 0x16d20cd920c409abn,
    bucket: 39,
    why: "very long: 1000 ASCII bytes",
  },
  {
    salt: "canary",
    key: `${LONG_ASCII}0`,
    raw: 0x8af56ff2ad1c5261n,
    bucket: 21,
    why: "very long, one byte longer",
  },
  {
    salt: "canary",
    key: LONG_CJK,
    raw: 0x1030cb769e14888bn,
    bucket: 23,
    why: "very long: 1800 UTF-8 bytes of CJK",
  },
