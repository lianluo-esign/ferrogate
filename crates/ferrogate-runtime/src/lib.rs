...
pub use managed_external_action::{
    ...
    normalized_event_from_canonical_json, self_hosted_external_action_report,
    ExternalActionAuthorizationError, ExternalActionAuthorizationRequest,
    ExternalActionAuthorizationResponse, ExternalActionBrowserOperation, ExternalActionDecision,
    ExternalActionFilesystemAccess, ExternalActionFramework, ExternalActionMemoryAccess,
