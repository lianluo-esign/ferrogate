...
// business logic. The credential-only cases moved to
// `ferrogate-gateway/src/auth_test.rs` with the code they cover (#553 stage 3b-0);
// every case left here drives a real `AppState`.
