...
pub(super) enum VersionResolution {
    Exact,
    Channel(String),
    Range(String),
}
...
impl VersionResolution {
    pub(super) fn header_value(&self, version: &str) -> String {
        match self {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(super) struct ResolvedVersion {
    ...
    pub(super) how: VersionResolution,
}
...
pub(super) enum VariantChoice<'a> {
