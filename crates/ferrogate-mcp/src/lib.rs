...
pub use protocol::{
    ...
    verify_routing_headers, RoutingHeaderMismatch, MCP_METHOD_HEADER, MCP_NAME_HEADER,
    MCP_PROTOCOL_VERSION, MCP_PROTOCOL_VERSION_FALLBACK, SUPPORTED_MCP_PROTOCOL_VERSIONS,
};
