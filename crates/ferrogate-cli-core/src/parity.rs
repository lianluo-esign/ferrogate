...
pub const REVIEWED_EXCLUSIONS: &[ReviewedExclusion] = &[
    // Guardrail policy-revision lifecycle — verbs not yet built. Owner: guardrail governance track (#362 follow-up).
    ReviewedExclusion {
        operation_id: "activateGuardrailPolicyRevision",
        owner: "guardrail governance (#362)",
        reason: "guardrail policy-revision/investigation family not yet implemented; tracked as #362 follow-up",
    },
    ReviewedExclusion {
    ...
    ReviewedExclusion {
        operation_id: "getGuardrailInvestigation",
        owner: "guardrail governance (#362)",
        reason: "guardrail policy-revision/investigation family not yet implemented; tracked as #362 follow-up",
    },
    ReviewedExclusion {
    ...
    ReviewedExclusion {
        operation_id: "listGuardrailEvaluations",
        owner: "guardrail governance (#362)",
        reason: "guardrail policy-revision/investigation family not yet implemented; tracked as #362 follow-up",
    },
    ReviewedExclusion {
    ...
    // Tool-approval workflow — verbs not yet built. Owner: agent governance track (#362 follow-up).
    ReviewedExclusion {
        operation_id: "approveAdminToolApproval",
        owner: "agent governance (#362)",
        reason: "tool-approval workflow family not yet implemented; tracked as #362 follow-up",
    },
    ReviewedExclusion {
        operation_id: "denyAdminToolApproval",
        owner: "agent governance (#362)",
        reason: "tool-approval workflow family not yet implemented; tracked as #362 follow-up",
    },
    ReviewedExclusion {
        operation_id: "expireAdminToolApproval",
        owner: "agent governance (#362)",
        reason: "tool-approval workflow family not yet implemented; tracked as #362 follow-up",
    },
    ReviewedExclusion {
        operation_id: "getAdminToolApproval",
        owner: "agent governance (#362)",
        reason: "tool-approval workflow family not yet implemented; tracked as #362 follow-up",
    },
    ReviewedExclusion {
        operation_id: "listAdminToolApprovals",
        owner: "agent governance (#362)",
        reason: "tool-approval workflow family not yet implemented; tracked as #362 follow-up",
    },
