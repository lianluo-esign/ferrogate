...
pub fn runtime_storage_repositories(config: &Config) -> anyhow::Result<RuntimeStorageRepositories> {
...
fn tool_response_from_mcp(
    ...
    ToolExecutionResponse {
        ...
        budget: crate::server::asset_admission::ResponseBufferBudget::none(),
    }
}
