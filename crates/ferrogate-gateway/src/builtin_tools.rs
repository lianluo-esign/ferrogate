...
use crate::server::asset_admission::{BufferedObject, ResponseBufferBudget};
...
/// aggregate budget by [`ReadResidency::InlinedInJsonResponse`](crate::server::asset_admission::ReadResidency::InlinedInJsonResponse).
///
