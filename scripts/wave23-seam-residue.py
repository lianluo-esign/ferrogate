#!/usr/bin/env python3
"""Wave-23 seam pass, the RESIDUE: the 22 rows the generic driver could not honestly prove.
...
def main():
    ...
    json.dump(results, open("/tmp/wave23-residue-results.json", "w"), indent=1)
