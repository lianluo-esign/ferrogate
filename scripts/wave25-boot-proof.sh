#!/usr/bin/env bash
# Wave-25 boot proof (FINAL, pre-deletion): five Workers, real `wrangler dev --local`, distinct ports.
#
...
APPS=(gateway:8841 control-plane:8842 mcp:8843 agent-runtime:8844 telemetry:8845)
PIDS=()
