#!/usr/bin/env python3
"""Wave-23 FULL seam pass — EVERY row in MOUNT-SEAMS.md, not an incremental subset.
...
def main():
    ...
    for i, r in enumerate(work, 1):
        ...
        marker = f"MUTW23_{rid.replace('-', '_')}"
        before = sha256(path)
    ...
    out_path = "/tmp/wave23-seam-results.json"
