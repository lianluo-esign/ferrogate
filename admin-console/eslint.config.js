...
const I18N_UNMIGRATED_ALLOWLIST = [
  ...
  "src/pages/agent-run-detail.tsx",
  "src/pages/agent-runs.tsx",
  "src/pages/agent-schedules.tsx",
  "src/pages/assets.tsx",
  "src/pages/billing-dead-letters.tsx",
  "src/pages/billing-metering.tsx",
  "src/pages/billing-payment-methods.tsx",
  "src/pages/billing-wallets.tsx",
  "src/pages/guardrail-evaluations.tsx",
  "src/pages/guardrail-policies.tsx",
  "src/pages/guardrail-policy-detail.tsx",
