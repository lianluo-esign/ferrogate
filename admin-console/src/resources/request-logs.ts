...
export const requestLogsConfig: ResourceConfig<AdminRequestLog> = {
  ...
  columns: [
    {
      key: "request_id",
      headerKey: "resource.requestLogs.col.requestId",
      priority: "primary",
      minWidth: 210,
      copyable: true,
    ...
    {
      key: "route",
      headerKey: "resource.requestLogs.col.route",
      priority: "detail",
      minWidth: 160,
    ...
    {
      key: "provider",
      headerKey: "resource.requestLogs.col.provider",
      priority: "secondary",
      minWidth: 120,
      mobileVisibility: "always",
    },
    {
      key: "logical_model",
      headerKey: "resource.requestLogs.col.model",
      priority: "secondary",
      minWidth: 180,
      mobileVisibility: "always",
    },
    {
      key: "status_code",
      headerKey: "resource.requestLogs.col.status",
      priority: "secondary",
      minWidth: 90,
      mobileVisibility: "always",
    },
    {
      key: "error_code",
      headerKey: "resource.requestLogs.col.error",
      priority: "detail",
      minWidth: 160,
      mobileVisibility: "details",
    },
