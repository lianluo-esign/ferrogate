/**
 * ONE contract-driven auth middleware for all 266 operations.
 *
 ...
 * keeps all 266 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 266 contract operations and
