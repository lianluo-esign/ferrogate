/**
 * ONE contract-driven auth middleware for all 280 operations.
 *
 ...
 * keeps all 280 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 280 contract operations and
