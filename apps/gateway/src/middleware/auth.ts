/**
 * ONE contract-driven auth middleware for all 281 operations.
 *
 ...
 * keeps all 281 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 281 contract operations and
