/**
 * ONE contract-driven auth middleware for all 257 operations.
 *
 ...
 * keeps all 257 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 257 contract operations and
