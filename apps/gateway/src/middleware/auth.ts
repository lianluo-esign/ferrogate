/**
 * ONE contract-driven auth middleware for all 278 operations.
 *
 ...
 * keeps all 278 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 278 contract operations and
