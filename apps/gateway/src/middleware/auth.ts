/**
 * ONE contract-driven auth middleware for all 259 operations.
 *
 ...
 * keeps all 259 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 259 contract operations and
