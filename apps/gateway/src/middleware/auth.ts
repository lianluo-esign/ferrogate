/**
 * ONE contract-driven auth middleware for all 258 operations.
 *
 ...
 * keeps all 258 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 258 contract operations and
