/**
 * ONE contract-driven auth middleware for all 264 operations.
 *
 ...
 * keeps all 264 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 264 contract operations and
