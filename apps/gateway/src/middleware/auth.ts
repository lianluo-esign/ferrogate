/**
 * ONE contract-driven auth middleware for all 252 operations.
 *
 ...
 * keeps all 252 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 252 contract operations and
