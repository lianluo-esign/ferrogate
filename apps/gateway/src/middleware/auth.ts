/**
 * ONE contract-driven auth middleware for all 267 operations.
 *
 ...
 * keeps all 267 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 267 contract operations and
