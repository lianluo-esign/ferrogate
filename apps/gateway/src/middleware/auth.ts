/**
 * ONE contract-driven auth middleware for all 254 operations.
 *
 ...
 * keeps all 254 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 254 contract operations and
