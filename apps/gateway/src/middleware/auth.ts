/**
 * ONE contract-driven auth middleware for all 272 operations.
 *
 ...
 * keeps all 272 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 272 contract operations and
