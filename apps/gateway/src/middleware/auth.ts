/**
 * ONE contract-driven auth middleware for all 275 operations.
 *
 ...
 * keeps all 275 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 275 contract operations and
