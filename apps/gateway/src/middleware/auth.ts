/**
 * ONE contract-driven auth middleware for all 265 operations.
 *
 ...
 * keeps all 265 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 265 contract operations and
