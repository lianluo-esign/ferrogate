/**
 * ONE contract-driven auth middleware for all 255 operations.
 *
 ...
 * keeps all 255 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 255 contract operations and
