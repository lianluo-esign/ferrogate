/**
 * ONE contract-driven auth middleware for all 261 operations.
 *
 ...
 * keeps all 261 in sync." This is that middleware. It matches the request
...
async function methodDependentRequiredScope(
  ...
  if (scope === undefined) {
    ...
    // be produced HERE: this middleware guards all 261 contract operations and
