 ...
 *
 * CORS is applied app-wide by `src/middleware/cors.ts`, before the contract
 * guard. Keeping it outside this response helper covers asset, site, tooling,
 * and inference routes with one consistent `Vary`/preflight contract.
 */
