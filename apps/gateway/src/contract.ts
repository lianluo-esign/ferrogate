/**
 * The 276-operation runtime API contract, as a typed, table-driven route table.
 *
 ...
 *
 * Nothing here is gateway-specific: all 276 operations are present, including
...
/** One of the 276 contract operations (Rust `ApiOperation`). */
 ...
 */
export const EXPECTED_OPERATION_COUNT = 276;
