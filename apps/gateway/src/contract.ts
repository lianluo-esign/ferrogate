/**
 * The 279-operation runtime API contract, as a typed, table-driven route table.
 *
 ...
 *
 * Nothing here is gateway-specific: all 279 operations are present, including
...
/** One of the 279 contract operations (Rust `ApiOperation`). */
 ...
 */
export const EXPECTED_OPERATION_COUNT = 279;
