/**
 * The 297-operation runtime API contract, as a typed, table-driven route table.
 *
 ...
 *
 * Nothing here is gateway-specific: all 297 operations are present, including
 ...
 */
export const EXPECTED_OPERATION_COUNT = 297;
