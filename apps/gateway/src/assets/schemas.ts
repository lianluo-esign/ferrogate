...
export const RESERVED_ASSET_TYPE_SEGMENTS = [
  "storage",
  "withheld",
  "presign",
  "openai_file",
...
/** OpenAI Files resource ids are generated by the gateway, not caller paths. */
export const fileIdSchema = z
  .string()
  .regex(/^file-[A-Za-z0-9_-]+$/, "must be a gateway-issued file id")
  .max(128);

export const fileIdParamsSchema = z.object({ file_id: fileIdSchema });

/** `GET /v1/files` narrowing and cursor parameters. */
...
/** OpenAI-compatible Files API object. */
