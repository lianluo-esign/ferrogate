 ...
 */
export function rbacAuthorizerFromEnv(env: { DB?: unknown }): RbacAuthorizerPort {
  return isRbacDatabase(env.DB) ? new D1RbacAuthorizer(env.DB) : new UnboundRbacAuthorizer();
}
