...
/**
 * The routes `src/index.ts` mounts that are not among the 200 operations this
...
describe("the app src/index.ts exports has all 200 operations in its ROUTING TABLE", () => {
  ...
  it("mounts NOTHING beyond the 200 + the shared probes + /health + /version", () => {
...
describe("every contract GROUP is reachable on the deployed Worker", () => {
  it("covers all 31 owned groups — a new group cannot slip past this table", () => {
