/**
 * The control-plane slice of the 261-operation runtime API contract, as a
 ...
 *     `group`, restricted to the 206 operations `ROUTE-MAP.md` assigns to
 *     `apps/control-plane`.
 *
...
export const EXPECTED_TOTAL_OPERATION_COUNT = 261;
 ...
 * `GET /metrics` (5).
 */
export const EXPECTED_CONTROL_PLANE_OPERATION_COUNT = 206;
...
/** Every operation in the document, in document order (all 261). */
...
/** Lookup by `operation_id` — across ALL 261, so a mis-assignment is visible. */
