/**
 * The control-plane slice of the 267-operation runtime API contract, as a
...
export const EXPECTED_TOTAL_OPERATION_COUNT = 267;
...
/** Every operation in the document, in document order (all 267). */
...
/** Lookup by `operation_id` — across ALL 267, so a mis-assignment is visible. */
