 ...
 *
 * `docs/openapi/runtime-api-contract.json` has 264 operations and none of them
 ...
 * contract operation; a path that is not one of the 209 is waved straight
 ...
 * applies to the 209 — imported, not re-implemented, so a change to the rule
