 ...
 *
 * `docs/openapi/runtime-api-contract.json` has 261 operations and none of them
 ...
 * contract operation; a path that is not one of the 206 is waved straight
 ...
 * applies to the 206 — imported, not re-implemented, so a change to the rule
