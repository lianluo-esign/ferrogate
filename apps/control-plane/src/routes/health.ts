 ...
 * `src/index.ts` already calls for the 203 contract operations — and NOT from
 ...
 * returns, so the 203-operation count `test/wiring.test.ts` pins does not move.
 *
 ...
 * because neither path is one of the 203 operations it guards, which is how
