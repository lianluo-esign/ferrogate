 ...
 * `src/index.ts` already calls for the 211 contract operations — and NOT from
 ...
 * returns, so the 211-operation count `test/wiring.test.ts` pins does not move.
 *
 ...
 * because neither path is one of the 211 operations it guards, which is how
