 ...
 * `src/index.ts` already calls for the 200 contract operations — and NOT from
 ...
 * returns, so the 200-operation count `test/wiring.test.ts` pins does not move.
 *
 ...
 * because neither path is one of the 200 operations it guards, which is how
