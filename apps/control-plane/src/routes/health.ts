 ...
 * `src/index.ts` already calls for the 197 contract operations — and NOT from
 ...
 * returns, so the 197-operation count `test/wiring.test.ts` pins does not move.
 *
 ...
 * because neither path is one of the 197 operations it guards, which is how
