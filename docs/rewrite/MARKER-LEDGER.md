...
| P34 | `packages/providers/src/registry.ts:8` | The Cloudflare AI Gateway routing leg of `ProviderAdapterRegistry` is not mounted (only `isRetryableStatus` is). | ~2 d |
