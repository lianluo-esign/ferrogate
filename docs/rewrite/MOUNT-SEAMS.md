...
| `WORKERD-REFUSAL` | exercising the seam takes the runtime to a start-up refusal and the suite to 0 collected tests; only the rot directions are gated | 2 — MCP-T10, AR-T10 |
